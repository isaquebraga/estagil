                ...
                <h1 className="title">Estágios disponíveis: </h1>
                    <div className="estagios">
                        <div className="estagio">
                            ...
                            <a href="http://localhost:3000/login"><div className="inscrever"><p>Enviar e-mail</p></div></a>
                        </div>
                        <div className="estagio">
                            ...
                            <a href="http://localhost:3000/login"><div className="inscrever"><p>Site da empresa</p></div></a>
                        </div>
                        <div className="estagio">
